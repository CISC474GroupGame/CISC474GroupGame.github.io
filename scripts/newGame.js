...
let canvas, context, currentLevel, player;
let init = function(){
...
let update = function() {
    ...
    // console.log("player velocity y: ", player.)
...
//function for detecting collision between two objects
